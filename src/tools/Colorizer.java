...
public class Colorizer implements ImageProcessor {
     ...
     *
     * @param ratio ratio to apply, in [0.; 1.]
     */
        ...
        for (int x = 0; x < maxX; x++) {
            for (int y = 0; y < maxY; y++) {
                ...
                switch (this.changeColor) {
                    ...
                    default:
                        System.err.println(
                                "Unexpected color: " + this.changeColor);
                }
                colorToChange = (Math.min((int) (colorToChange * this.ratio),
                        255)) << decalage;
                myBufferedImage.setRGB(x, y,
                        (colorToChange + secondColor + thirdColor));
            }
